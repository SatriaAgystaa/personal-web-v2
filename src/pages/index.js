    ...
    <div className="sm:w-full md:w-3/5 font-sans px-8 py-6 flex justify-center overflow-hidden mt-16 sm:mt-16 md:mt-0">
      <div className="max-w-[1200px] w-full font-sans flex flex-col justify-center items-center">
        ...
        <header className="mb-8">
          <h1 className="text-3xl font-semibold mb-3 transition-all duration-300">
            Hi, I'm Satria
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mb-2 transition-all duration-300">Based in Bandung, Indonesia</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center">
            {[ 
              ...
              >
                ...
                <p className="text-sm text-gray-800 dark:text-gray-300">{skill.desc}</p>
              </motion.div>
            ))}
          </div>
        </section>
